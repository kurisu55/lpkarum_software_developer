...
<body id="page-top">
    ...
    <section class="page-section">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="border border-secondary col col-md-5 me-5">
                    <h1 class="text-center mt-2">FORM PENGISIAN</h1>
                    <form action="" method="post">
                        <div class="col-6 ms-3">
                            <label for="userId" class="col-form-label">Nomor Kependudukan : </label>
                            <input type="text" name="userId" class="form-control" id="userId" placeholder="" disabled>
                        </div>
                        <div class="col-6 ms-3">
                ...
                <div class="border border-secondary col col-md-5 ms-5">
