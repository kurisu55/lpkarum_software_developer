...
// Get Date Data
var_dump($result['tanggalLahir']);
$slashDate = explode('-', $result['tanggalLahir']);
$dataDate = implode('-', [$slashDate[2], $slashDate[1], $slashDate[0]]);
$resultDate = $_POST['tanggalLahir'] ? $_POST['tanggalLahir'] : $dataDate;
            ...
            <div class="row">
                <div class="border border-secondary col">
                    ...
                    <form action="" method="post">
                        <input type="text" name="id" id="id" value="<?= $_POST['userId']; ?>" readonly hidden>
                        ...
                        <div class="row">
                            <div class="col-5 ms-3">
                                ...
                                <input type="date" name="tanggalLahir" class="form-control" id="tanggalLahir" value="<?= $resultDate; ?>">
                            </div>
                            <div class="col-5 ms-3">
